...
interface EmailConfirmedScreenProps extends AppStackScreenProps<"EmailConfirmed"> {}

export const EmailConfirmedScreen: FC<EmailConfirmedScreenProps> = observer(
  function EmailConfirmedScreen(_props) {
      ...
      <Screen preset="auto" contentContainerStyle={$screenContentContainer} safeAreaEdges={["top"]}>
        <View style={$screenViewContainer}>
          <View style={$confirmTextContainer}>
            ...
            <Text text="Email Confirmed" preset="subheading" style={$confirmText} />
            <Text
              text={`Welcome to HookPnP, time to start exploring`}
              preset="default"
